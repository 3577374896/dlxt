$(function(){
    ...
    var musicImgsData = ['img/bg.jpg','img/bg1.jpg','img/bg2.jpg','img/bg3.jpg','img/bg4.jpg','img/bg5.jpg','img/bg6.jpg','img/bg7.jpg','img/bg8.jpg','img/bg9.jpg','img/bg10.jpg','img/bg11.jpg']    // 图片地址数组
    var musicNameData = ['出山','盗将行','归去来兮','All time low','all time low','alone','collapsing world','drown','faded','feel the fire','flash funk'];                   // 歌曲名数组
    var artistNameData = ['花粥/王胜娚','花粥/马雨阳','花粥','未知','sam tsui','alan walker','Lightscape','Martin Garrix','Martin Garrix','Alan Walker','未知','Marshmello']            // 创作歌手数组
    var musicUrls=['mp3/music1.mp3','mp3/music2.mp3','mp3/music3.mp3','mp3/music4.mp3','mp3/All Time Low - Sam Tsui.mp3','mp3/Alone - Alan Walker.mp3','mp3/Collapsing World (Original Mix) - Lightscape.mp3','mp3/Drown (Alle Farben Remix) - Martin Garrix.mp3','mp3/Faded (XM Remix) - Alan Walker.mp3','mp3/feel the fire.mp3','mp3/Flash Funk (Marshmello Remix) - Marshmello.mp3'];// 歌曲mp3数组
